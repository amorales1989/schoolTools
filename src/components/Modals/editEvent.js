...
export default function EditEventModal({ visible, onClose, selectedEvent }) {
    ...
    useEffect(() => {
        if (selectedEvent) {
            ...
            setEventTime(new Date(selectedEvent.eventDate + 'T' + selectedEvent.eventTime));
        }
    }, [selectedEvent]);
    ...
    const handleSave = async () => {
        ...
        await editEvent(selectedEvent.id, body);
        // Cierra el modal
        onClose();
        setEventTitle('');
